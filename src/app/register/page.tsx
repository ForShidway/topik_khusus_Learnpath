      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: "32px" }}>
          ...
          <h1 style={{ fontSize: "1.8rem", fontWeight: 800, color: "#1e1b4b", marginBottom: "6px" }}>
            Buat Akun <span style={{ color: "#6366f1" }}>Gratis</span>
          </h1>
          <p style={{ color: "#6b7280", fontSize: "0.9rem" }}>
            Daftar dan mulai perjalanan belajarmu bersama AI!
          </p>
        </div>
        ...
        <form action={action} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          {/* Nama */}
          <div>
            <label htmlFor="name" style={{ display:"block", fontSize:"0.875rem", fontWeight:600, color:"#374151", marginBottom:"6px" }}>
              Nama Lengkap
            </label>
            <input
              ...
              onBlur={(e) => { e.currentTarget.style.borderColor = state?.errors?.name ? "#ef4444" : "#e5e7eb"; }}
            />
            {state?.errors?.name && (
              <p style={{ color:"#ef4444", fontSize:"0.8rem", marginTop:"4px" }}>{state.errors.name[0]}</p>
            )}
          </div>

          {/* Email */}
          <div>
            <label htmlFor="email" style={{ display:"block", fontSize:"0.875rem", fontWeight:600, color:"#374151", marginBottom:"6px" }}>
              Email
            </label>
            <input
            ...
            />
            {state?.errors?.email && (
              <p style={{ color:"#ef4444", fontSize:"0.8rem", marginTop:"4px" }}>{state.errors.email[0]}</p>
            )}
          </div>

          {/* Password */}
          <div>
            <label htmlFor="password" style={{ display:"block", fontSize:"0.875rem", fontWeight:600, color:"#374151", marginBottom:"6px" }}>
              Password
            </label>
            <input
            ...
            {state?.errors?.password && (
              <p style={{ color:"#ef4444", fontSize:"0.8rem", marginTop:"4px" }}>{state.errors.password[0]}</p>
            )}
          </div>

          {/* Konfirmasi Password */}
          <div>
            <label htmlFor="confirmPassword" style={{ display:"block", fontSize:"0.875rem", fontWeight:600, color:"#374151", marginBottom:"6px" }}>
              Konfirmasi Password
            </label>
            <input
              ...
              onFocus={(e) => { e.currentTarget.style.borderColor = "#6366f1"; }}
              onBlur={(e) => { e.currentTarget.style.borderColor = state?.errors?.confirmPassword ? "#ef4444" : "#e5e7eb"; }}
            />
            {state?.errors?.confirmPassword && (
              <p style={{ color:"#ef4444", fontSize:"0.8rem", marginTop:"4px" }}>{state.errors.confirmPassword[0]}</p>
            )}
          </div>
        ...
        <div style={{ textAlign: "center", marginTop: "24px" }}>
          ...
          <p style={{ marginTop: "10px" }}>
            <Link href="/" style={{ color: "#9ca3af", fontSize: "0.82rem", textDecoration: "none" }}>
              ← Kembali ke Beranda
            </Link>
          </p>
        </div>
